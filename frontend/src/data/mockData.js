...
export const socialLinks = [
  ...
  { name: "Email", url: "mailto:alex.rivera@example.com", icon: "mail" }
];
...
export const experiences = [
  ...
  },
  {
    ...
    duration: "2020 - 2022",
    description: "Built and maintained multiple client projects ranging from e-commerce platforms to internal dashboards. Collaborated with cross-functional teams.",
